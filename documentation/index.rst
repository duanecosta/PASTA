...
#. **About the LTER Network Information System:** Overview and motivation for the LTER Network Information System - the LTER Data Cooperative, data producers, and data consumers.

#. **Documentation for Users of the LTER Data Portal:** The LTER Data Portal is the official web-browser interface for users to upload, search, and download LTER data products. The Data Portal is considered a reference implementation of an application that utilizes the PASTA Application Program Interface (API).
